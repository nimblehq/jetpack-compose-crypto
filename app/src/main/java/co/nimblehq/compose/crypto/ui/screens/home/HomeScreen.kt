    ...
    Surface {
        BoxWithConstraints {
            ...
            Column(
                ...
                PortfolioCard(modifier = Modifier.padding(top = Dp40))
...
private fun Coins(screenHeight: Dp) {
    ConstraintLayout(
        ...
        LazyRow(
            modifier = Modifier.constrainAs(myCoins) {
        ...
        Text(
            modifier = Modifier.constrainAs(trendingTitle) {
        ...
        LazyColumn(
            modifier = Modifier.constrainAs(trending) {
